	...
	<div class="">
		<div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <!-- Add Button -->
                  <a class="btn btn-app" href="<c:url value="/role/add"/>"><i class="fa fa-plus"></i> Add</a>
                  <!-- Form Search -->
	                    ...
	                    <div class="table-responsive">
	                      <table class="table table-striped jambo_table bulk_action">
	                        ...
	                        <c:forEach items="${roles}" var="role" varStatus="loop">
	                            ...
	                            <td class="text-center"><a href="<c:url value="/role/view/${role.id}"/>" class="btn btn-round btn-default" href="#">View</a>
	                            <td class="text-center"><a href="<c:url value="/role/edit/${role.id}"/>" class="btn btn-round btn-primary" href="#">Edit</a>
	                            <td class="text-center"><a onclick="confirmDelete(${role.id});" class="btn btn-round btn-danger" href="#">Delete</a>
	                            </td>
	                         </c:forEach>
